...
| 84 | Metal self-overflow | concentration ≥5 (e.g. Metal + Drought) | **Wasteland** | 🧟 | Metal 1.0 | The landscape Drought has left — structure remaining, life departed. Distinct from the Metal Storm **Drought** (the absence-of-water itself) by tense: a Wasteland is *what remains* after sustained Drought. |
